        ...
        onTap: (){
          showDialog(context: context,
            builder: (BuildContext context){
              return AlertDialog(
                title: Text('This link will take you to an external website. http://djb.gov.in',
                style: Theme.of(context).textTheme.display2,
                ),
                actions: <Widget>[
                  FlatButton(
      ...
      child:GestureDetector(
        onTap: (){
          showDialog(context: context,
              builder: (BuildContext context){
                return AlertDialog(
                  title: Text('This link will take you to an external website. https://delhijalboard.nic.in ',
                    style: Theme.of(context).textTheme.display2,
                  ),
                  actions: <Widget>[
                    FlatButton(
